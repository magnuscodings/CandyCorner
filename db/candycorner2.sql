...
--
-- Dumping data for table `order_cancel_records`
--

INSERT INTO `order_cancel_records` (`order_cancel_record_id`, `order_cancel_record_user_id`, `order_cancel_record_reason`, `order_cancel_record_datetime`, `order_cancel_record_type`, `order_cancel_record_order_id`) VALUES
(1, 25, 'test', '2023-06-09 01:16:07', 0, 195759);
...
CREATE TABLE `stocks` (
  ...
  `stock_expiration` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `stocks` (`stock_id`, `stock_prod_id`, `stock_barcode`, `stock_datetime`, `stock_status`, `stock_expiration`) VALUES
(1, 2, '2-Ce000395-450652.png', '2023-06-08 22:37:24', 0, '2023-06-08'),
(2, 2, '2-Ce000395-977414.png', '2023-06-08 22:37:24', 0, '2023-06-08'),
(3, 5, '5-Ce000394-495246.png', '2023-06-08 22:38:17', 0, '2023-06-08'),
(4, 5, '5-Ce000394-778644.png', '2023-06-08 22:38:17', 0, '2023-06-08'),
(5, 5, '5-Ce000394-153220.png', '2023-06-08 22:38:17', 0, '2023-06-08'),
(6, 8, '8-Ce000467-225874.png', '2023-06-09 00:00:05', 0, '2023-07-01'),
(7, 8, '8-Ce000467-472057.png', '2023-06-09 00:00:05', 0, '2023-07-01');
...
(29, 'name1@name1', 'name1@name1', 'name1', 0, 1),
(30, 'asd@aaa', 'admin@admin', 'test', 0, 1),
(31, 'mr.ephraiel@gmail.com2', 'mr.ephraiel@gmail.com', 'tester', 0, 1),
(32, 'mr.ephraiel@gmail.com2s', 'mr.ephraiel@gmail.com', 'tester', 0, 1);
...
--
ALTER TABLE `order_cancel_records`
  MODIFY `order_cancel_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `users`
  MODIFY `u_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
COMMIT;
